...
<body>
          ...
          <div class="sidebar">
                    ...
                    <ul>
                              ...
                              <li style="background-color: #F5E8C7;"><a href="Track2.php"><i class="fa solid fa-truck-fast"></i>Track Shipment</a></li>
                              <li><a href="index.php"><i class="fa solid fa-book"></i>Services</a></li>
                              <li  ><a href="Bookings.php"><i class="fa regular fa-file"></i>Bookings</a></li>
                    </ul>
                    <div class="social">
                    ...
                    <div class="main_content">
                              <div class="header">Booking Track</div>
                    </div>
                    <form method="post">
                    
                              Enter Email :<br><br>
                              <input type="email" name="book_email" placeholder="Enter Email" required><br><br>
                              <input type="submit" name="submit" value="TRACK" id="submit">
